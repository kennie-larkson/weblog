...
export class AirbnbController {
  ...
  private initializeRoutes() {
    this.router.get(`${this.path}/listings`, this.getListings);
    this.router.get(`${this.path}/listings/data`, this.getListingData);
    this.router.get(`${this.path}/travel/details`, this.getTraveldetails);
  }

  getListings(req: Request, res: Response, next: NextFunction) {
    res.status(200).json([
      {
  ...
  getListingData(req: Request, res: Response, next: NextFunction) {
    res.status(200).json([
      {
  ...
  getTraveldetails(req: Request, res: Response, next: NextFunction) {
    res.status(200).json([
      {
