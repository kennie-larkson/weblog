...
var AuthController = /** @class */ (function () {
    function AuthController() {
        ...
        this.authService = new authentication_service_1.default();
        this.registration = function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.authService.register(userData)];
                    case 2:
    ...
    AuthController.prototype.initializeRoutes = function () {
        this.router.post("".concat(this.path, "/register"), validation_middleware_1.validateUserForm, this.registration);
    };
