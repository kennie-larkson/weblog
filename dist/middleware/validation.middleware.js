...
exports.hashPassword = exports.validatePostForm = exports.validateUserForm = void 0;
var bcrypt_1 = __importDefault(require("bcrypt"));
function validateUserForm(req, res, next) {
    var _a = req.body, name = _a.name, email = _a.email, password = _a.password, confirmPassword = _a.confirmPassword;
...
function validatePostForm(req, res, next) {
    var _a = req.body, author = _a.author, content = _a.content, title = _a.title;
    try {
